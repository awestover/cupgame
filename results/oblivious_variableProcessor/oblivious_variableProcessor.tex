...
\begin{lemma}[The Oblivious Amplification Lemma]
  ...
  {\color{red} either of the $1/2$ factor out front or the $\eta^\ell$ factor in the argument seems to be enough to completely kill the corollary. These seem not very avoiable though. So I guess work on fixing up the corollary to deal with it? hmm that seems impossible.}
\end{lemma}
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item \textbf{Step 2:} Reduce the number of processors to $p=n\delta\eta$
      use the high fill in $n\delta\eta$ unknown cups, along with the
      greedyness of the emptier to attain $n\delta\eta$ known cups with high

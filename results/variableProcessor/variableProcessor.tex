...
\begin{lemma}[The Oblivious Amplification Lemma]
  ...
  Let $0< \delta \ll 1/2$, $L\in \mathbb{N}$, and $\eta \in \mathbb{N}$ ($\eta$
  chosen sufficiently large as a function of $\delta, \Delta$), be appropriate constant
  parameters. Let $0 \ll \phi<1$ be a constant which will be defined in terms
  of $\eta$ satisfying $\lim_{\eta \to \infty} \phi = 1$. 

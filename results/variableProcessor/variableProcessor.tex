...
\end{proof}
  ...
  % , which by Hoeffding's Inequality will have average fill close to $0$, 
  ...
  % THIS IS HONESTLY BOGUS, the fill need not be concentrated in a small number
  % of cups, so this only works against a (0, 0)-greedy emptier.

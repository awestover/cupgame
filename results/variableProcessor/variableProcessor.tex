...
\begin{proof}
  ...
  that $cg_0^{1-\epsilon} -1 < f_0(g_0)$ implying, as $\delta$
  will be chosen small enough so that $g_0 = \ceil{1/\delta} \ge n_0$, that
  $$c \le \frac{f_0(g_0)+1}{g_0^{1-\epsilon}} = \frac{2}{g_0^{1-\epsilon}} = \frac{2}{\ceil{\delta}^{1-\epsilon}}.$$

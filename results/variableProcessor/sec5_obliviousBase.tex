\todo{turn skipping :x :x rip rip}

\todo{minor issue: integer stuff; don't sweat it for now, can
probably push this issue off to the next file worst comes to
worst}
...
\todo{i dont like the word always being used in these proofs, its
not quite true, say since the flattening of AB?}
...
\todo{most of the stuff below this point in the proof is false}

\todo{extract the good probability stuff from this skechy proof}

...
\begin{proof}
  ...
  design in choosing $n_B/n_A$ to be a sufficiently large
  constant, as was done in choosing $\delta = \Theta(e^{-2h})$,
  is at most $1$.
...
\begin{proof}
  ...
  because $|B|$ is at least a sufficiently large constant
  multiple of $|A|$, in particular by our choice of $\delta = \Theta(e^{-2h})$.
...
\begin{proof}
  ...
  actually with exponentially good probability in $M > N^2 > n$, but
